defmodule PlacesAlloverseCom.CMSTest do
  use PlacesAlloverseCom.DataCase

  alias PlacesAlloverseCom.CMS

  describe "pages" do
    alias PlacesAlloverseCom.CMS.Page

    @valid_attrs %{body: "some body", title: "some title", view: 42}
    @update_attrs %{body: "some updated body", title: "some updated title", view: 43}
    @invalid_attrs %{body: nil, title: nil, view: nil}
  ...
  describe "authors" do
    alias PlacesAlloverseCom.CMS.Author
